<template>
    <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            <router-link to="/admin" class="flex flex-col items-center justify-center">
                <button data-tooltip-target="tooltip-home" type="button"
                    class="inline-flex items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
                ...
                <Tooltip id="tooltip-home">Home</Tooltip>
            </router-link>
            ...
            <button data-tooltip-target="tooltip-wallet" type="button"
                ...
                <Tooltip id="tooltip-wallet">Wallet</Tooltip>
            </button>

            <router-link to="/lista" class="flex items-center justify-center">
                ...
                <Tooltip id="tooltip-new">Create new item</Tooltip>
            </router-link>
            ...
            <button data-tooltip-target="tooltip-settings" type="button"
                ...
                <Tooltip id="tooltip-settings">Settings</Tooltip>
            </button>
            ...
            <button data-tooltip-target="tooltip-profile" type="button"
                ...
                <Tooltip id="tooltip-profile">Profile</Tooltip>
            </button>
        </div>
    </div>
</template>
